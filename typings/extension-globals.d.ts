// VSCode no longer picks up this file from node_modules/web-ext-types so I'm copying it here manually.
// Weirdly the older version of typescript doesn't build using this file so I have to still include both.
// At some point I'll do something to fix this but not going to bother right now.
